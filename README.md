...
3. Filtering data by rules that we made.
   ...
   * data_result.csv : The result of sentiment score of titles and comments that we collected by Youtube.
   * data_collection.ipynb : This ipynb read the csv file and use pandas library to represent the sentimental scores of titles and comments.
